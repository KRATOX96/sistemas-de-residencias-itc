	        ...
	        <table class="table table-striped table-hover ">
			  ...
			  <tbody>
			    ...
			    <tr class="active">
			      ...
			      <td><a href="{{route('cartaPresentacion',$alumno->NODECONTROL)}}" style=" color: black ;"><button class="btn  btn-skin-green btn-xs"  > <span class="glyphicon glyphicon-eye-open"></span>
