...
@section('content')
        <div class="row">
            ...
            <div class="col-lg-4 col-md-offset-0" >
                ...
                <p style="text-align:left">En esta ventana usted debera enviar el documento de calificaciones del asesor externo ,pulse sobre el boton "adjuntar archivo",elija un documento  y a continuacion pulse en el boton aceptar.</p>
            </div>
                
                <div class="col-lg-8  ">
                    <div class="panel panel-primary ">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="margin-left:20px ;">Enviar calificacion del asesor externo</h3>
                        </div>
                            ...
                            <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                              ...
                              <div class="form-group">
                                  <div class="col-lg-8 col-lg-offset-1">
                                    <input type="file" class="" id="archivo3" name="archivo3" style="margin-bottom:10px" > 
